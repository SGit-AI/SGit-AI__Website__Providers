...
- **The canonical URL is the intent, the link is the reality.** A link goes wherever that site is measured to be serving, which is the canonical host once it answers and the project path before it does {{claim:domains-live}} — and the page says which.
